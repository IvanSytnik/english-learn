...
export const GRAMMAR_CONCEPTS: Concept[] = [
  ...
  },
  {
    ...
    cefrLevel: 'A2',
    category: 'GRAMMAR',
    description: 'Actions happening now or around now; temporary situations; future arrangements.',
  },
  {
  ...
  },
  {
    ...
    cefrLevel: 'B1',
    category: 'GRAMMAR',
    description: 'Regular -ed and irregular V3. Foundation for Present Perfect and passive voice.',
  },
  {
